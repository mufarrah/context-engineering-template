...
Contains: Feature summary, implementation phases table, key decisions, data model changes, required reading.
...
Contains: Files created/modified, data model changes, implementation notes, how to test.
...
8. **Periodic audits** — Run `/audit-context` regularly for project health
