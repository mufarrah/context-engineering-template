...
3. For each test case:
   ...
   c. Run validation using the project's validation method (from project AGENTS.md)
...
- Read the project's `AGENTS.md` for safety rules and coding standards
