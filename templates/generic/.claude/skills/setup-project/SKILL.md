---
name: setup-project
description: "Initialize a freshly copied Cortex single-project template by detecting the tech stack and populating AGENTS.md from your code. Run once after copying."
...
## STEP 2: POPULATE AGENTS.md

Read the current `AGENTS.md` and fill in the skeleton sections. (The thin `CLAUDE.md` just imports `AGENTS.md` — do not populate it.)
...
- Data model: if discoverable, document key data models, schemas, or types
- Key flows: document 2-3 key data flows or processes in the application
- API structure: if applicable, document the API organization

---

## STEP 3: INITIALIZE KNOWLEDGE BASE

### 3.1 Run Knowledge Base Population
...
Documentation Updated:
  - AGENTS.md — Coding standards, file organization, commands, architecture, data model, key flows populated
...
Next Steps:
  1. Review AGENTS.md and customize the coding standards and architecture details
  2. Start your first feature with /generate-requirements
```
