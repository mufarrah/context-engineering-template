...
- When onboarding a new codebase to the project
...
### 0.1 Read Project Navigation Files
...
### 0.2 Inventory Project

Identify the project:
- Tech stack (from AGENTS.md or package manager files)
...
- **NEVER** modify source documents (PRPs, AGENTS.md, etc.)
