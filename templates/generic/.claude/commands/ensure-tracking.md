...
- "PLANNING.md not updated with architecture changes"
...
PROJECT DOCUMENTATION:
  CLAUDE.md: Updated with {what}
  PLANNING.md: Updated with {what}
```
...
PROJECT DOCUMENTATION:
  CLAUDE.md: Missing new patterns from this phase
  PLANNING.md: Missing architecture changes
```
...
Project Docs:
  ...
  PLANNING.md updated (or "No changes needed")
...
### Project Docs
- [ ] CLAUDE.md has new patterns documented (if any)
- [ ] PLANNING.md has architecture changes documented (if any)
