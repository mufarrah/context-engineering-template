...
Read all `.md` files in `knowledge-base/implementations/` (excluding `_SUMMARY.md`):
...
├── implementations: [{filename, title, lastUpdated, summary}]
...
### 2.3 Implementations _SUMMARY.md
...
Implementation patterns that document WHERE and HOW code is organized. These are project-specific patterns, file organization conventions, and code examples.

## Reading Order

After understanding concepts and flows, read the implementation topics to get project-specific patterns and code examples.
