...
**Location:** `knowledge-base/implementations/{project-name}/`
**Contains:** Project-specific patterns, file locations, code conventions

**Example topics:**
- `web-app/forms-and-components.md` — Form patterns, component structure
- `api-service/route-patterns.md` — How API routes are organized
- `mobile-app/state-management.md` — State management approach

**When to create:** When a project establishes a pattern that should be followed.
...
- `002-booking-storage-model.md` — Why bookings use this specific schema
...
| `/populate-knowledge-base` | Full scan of all projects and docs |
...
| Scope | Single feature | Cross-feature, cross-project |
