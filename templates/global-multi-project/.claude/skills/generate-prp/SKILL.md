...
5. Include context files to read:
   - `AGENTS.md` (root) - Agent instructions: navigation, architecture, coding standards
   - `context-engineering/_STATUS.md` - Current workspace status and in-progress work
   - **Project-specific docs**: `active-projects/{PROJECT}/AGENTS.md`
6. Include validation commands from project AGENTS.md (build, lint, test commands)
7. **Add inline test cases section** to the PRP file:
   a. Read the target project's AGENTS.md for the validation method
...
- [ ] **Testing Approach section filled** with project-specific validation method from AGENTS.md

---

## STEP 8: UPDATE WORKSPACE STATUS
