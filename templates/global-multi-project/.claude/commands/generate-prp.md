...
5. Include context files to read:
   - `CLAUDE.md` (root) - Workspace navigation, workflow, and structure
   - `PLANNING.md` (root) - Repository organization and dev philosophy
   - `context-engineering/_STATUS.md` - Current workspace status and in-progress work
   - **Project-specific docs**: `active-projects/{PROJECT}/CLAUDE.md` and `PLANNING.md`
...
7. **Add inline test cases section** to the PRP file:
   a. Read the target project's CLAUDE.md for the validation method
...
8. **Generate TEST-CASES.md for each phase:**
   ...
   c. Read the target project's CLAUDE.md for the validation method:
